...
u = createUser('galileo', 'telescope1610@gmail.com', 
    'https://lh4.googleusercontent.com/-pTkJMUTdGDA/AAAAAAAAAAI/AAAAAAAAAAc/AMW9IgdH9AKuy9mu7D_nEl8hAoWkAnBhtw/s64-c-mo/photo.jpg')
...
createItem('Jalapeno Poppers',
    'Jalapeno poppers, or jalapeno bites, are jalapeno peppers that have been hollowed out, stuffed with a mixture of cheese, spices, and sometimes ground meat, breaded and deep fried.',
    appetizer.id,
...
createItem('Bhajji',
    'A bhajji, bhaji or bajji, is a spicy Indian snack similar to a fritter, with several variants. Outside the Indian states of Maharashtra, Andhra Pradesh, Tamil Nadu, and Karnataka, such preparations are often known as pakora. It is usually served as a topping with various Indian meals, but has become popular to eat alone as a snack.[citation needed] It is a popular street food in Maharashtra, Andhra Pradesh, Karnataka, and West Bengal in India, and can be found for sale in street-side stalls, especially in tapris (common food stalls on streets) and dhabas on highways.',
    snack.id,
    'bhaji.jpg',
    u.id    
    )
